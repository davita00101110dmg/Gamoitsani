        ...
        public enum Game {
            ...
            public enum CurrentExtraRound {
                ...
                public static func message(_ p1: String) -> String {
                    String(localized: "screen.game.current_extra_round.message")
                }
            }
            ...
            public enum CurrentRound {
                /// Round: %@
                public static func message(_ p1: String) -> String {
                    String(localized: "screen.game.current_round.message")
                }
            }
            ...
            public enum GameShareView {
                ...
                public static func title(_ p1: String) -> String {
                    String(localized: "screen.game.game_share_view.title")
                }
            }
            ...
            public enum WinningView {
                ...
                public static func description(_ p1: String) -> String {
                    String(localized: "screen.game.winning_view.description")
                }
                /// Repeat
        ...
        public enum GameDetails {
            ...
            public enum Players {
                ...
                public static func nameTooLong(_ p1: String) -> String {
                    String(localized: "screen.game_details.players.name_too_long")
                }
            ...
            public enum RoundsAmount {
                /// Amount: %@
                public static func title(_ p1: String) -> String {
                    String(localized: "screen.game_details.rounds_amount.title")
                }
            }
            ...
            public enum RoundsLength {
                /// Length: %@ sec
                public static func title(_ p1: String) -> String {
                    String(localized: "screen.game_details.rounds_length.title")
                }
            }
            ...
            public enum Teams {
                ...
                public static func nameTooLong(_ p1: String) -> String {
                    String(localized: "screen.game_details.teams.name_too_long")
                }
            }
        }
        ...
        public enum GameScoreboard {
            ...
            public enum PostGameScoreboard {
                ...
                public static func finalScore(_ p1: String) -> String {
                    String(localized: "screen.game_scoreboard.post_game_scoreboard.final_score")
                }
                /// Sets Skipped
