...
struct GamoitsaniApp: App {
    ...
    init() {
        ...
        // Both of these exist only because cutover inherited v1's container. Nothing
        // reads what this one removes, so it has no ordering constraint.
        LegacyStoreCleanup.run()
    }
