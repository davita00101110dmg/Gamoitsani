...
enum AppConstants {
    ...
    enum Firebase {
        ...
        enum Fields {
            ...
            static let isGeorgianOrigin = "is_georgian_origin"
            static let formalityLevel = "formality_level"
            static let isProperNoun = "is_proper_noun"
            static let wordType = "word_type"
            static let isAbstract = "is_abstract"
            static let ageAppropriateness = "age_appropriateness"
            static let relatedWords = "related_words"
